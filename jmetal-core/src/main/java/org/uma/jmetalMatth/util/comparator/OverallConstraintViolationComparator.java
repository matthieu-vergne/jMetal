 ...
 */
public class OverallConstraintViolationComparator<Encoding extends ConstrainedEncoding>
	...
	public int compare(Solution<?, Encoding> solution1,
		...
		double violationDegreeSolution1 = solution1.getEncoding()
				.getOverallConstraintViolationDegree();
		double violationDegreeSolution2 = solution2.getEncoding()
				.getOverallConstraintViolationDegree();
		...
		} else if ((violationDegreeSolution1 == 0)
				&& (violationDegreeSolution2 < 0)) {
			return -1;
		} else if ((violationDegreeSolution1 < 0)
				&& (violationDegreeSolution2 == 0)) {
			return 1;
